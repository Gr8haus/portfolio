...
const skills = [
    {
      name: "Javascript | React | HTML | CSS | Ruby | Rails | PostgreSQL | RSpec | Bootstrap ",
    },
...
const dataportfolio = [
    {
        ...
        description: "A FUN-ctional game for all ages. GIVE IT A GO!",
        link: "https://tic-tac-toe-wfej.onrender.com/",
    },
    {
      img: require("./assets/images/cattinder.png"),
      description: "The ultimate cat-ting edge technology in feline matchmaking.",
      link: "https://github.com/Gr8haus/cat-tinder-frontend-frazzled",
    },
    {
        img: require("./assets/images/bricks.png"),
        description: "The future of luxury living is made with bricks.",
        link: "https://github.com/learn-academy-2023-india/apartment-app-frontend-the-bricks",
    },
    // {
...
const contactConfig = {
    ...
    description:
      "Feel free to reach out to me via email or phone with any inquiries, questions, or possible collaboration opportunities. I'd love to hear from you and discuss how I can assist you further.",
    YOUR_SERVICE_ID: "service_uoad3ba",
    YOUR_TEMPLATE_ID: "template_tydqean",
    YOUR_USER_ID: "eeMmv0cgTqS96dMrv",
}
